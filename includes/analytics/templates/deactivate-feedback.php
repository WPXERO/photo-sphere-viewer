...
<script>
    jQuery(document).ready(function($) {
        ...
        $('tr[data-plugin="<?php echo $slug; ?>/<?php echo $slug; ?>.php"] .deactivate a').on('click', function(e) {
            e.preventDefault();
        ...
        $('#uc-deactivate-feedback-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        window.location.href = $('tr[data-plugin="<?php echo $slug; ?>/<?php echo $slug; ?>.php"] .deactivate a').attr('href');
                    }
                }
            });
        });
